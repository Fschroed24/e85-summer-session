...
class alignas(VL_CACHE_LINE_BYTES) Vtestbench___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ testbench__DOT__la;
    CData/*0:0*/ testbench__DOT__lb;
    CData/*0:0*/ testbench__DOT__lc;
    CData/*0:0*/ testbench__DOT__ra;
    CData/*0:0*/ testbench__DOT__rb;
    CData/*0:0*/ testbench__DOT__rc;

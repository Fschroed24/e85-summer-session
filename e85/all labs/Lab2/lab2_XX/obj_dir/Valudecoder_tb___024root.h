...
class alignas(VL_CACHE_LINE_BYTES) Valudecoder_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ aludecoder_tb__DOT__dut__DOT__T1;
    CData/*0:0*/ aludecoder_tb__DOT__dut__DOT__R;
    CData/*0:0*/ aludecoder_tb__DOT__dut__DOT__Z;
    CData/*0:0*/ aludecoder_tb__DOT__dut__DOT__S;

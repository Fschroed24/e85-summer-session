...
VL_ATTR_COLD void Vtestbench___024root__trace_init_sub__TOP__0(Vtestbench___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+13,0,"s",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+4,0,"sexpected",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+5,0,"coutexpected",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+15,0,"vectornum",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+16,0,"errors",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+6,0,"ns",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+7,0,"n1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+8,0,"n2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"n3",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+10,0,"n4",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
...
VL_ATTR_COLD void Vtestbench___024root__trace_full_0_sub_0(Vtestbench___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+3,(vlSelf->testbench__DOT__cin));
    bufp->fullBit(oldp+4,(vlSelf->testbench__DOT__sexpected));
    bufp->fullBit(oldp+5,(vlSelf->testbench__DOT__coutexpected));
    bufp->fullBit(oldp+6,(((IData)(vlSelf->testbench__DOT__a) 
                           ^ (IData)(vlSelf->testbench__DOT__b))));
    bufp->fullBit(oldp+7,(((IData)(vlSelf->testbench__DOT__a) 
                           & (IData)(vlSelf->testbench__DOT__b))));
    bufp->fullBit(oldp+8,(((IData)(vlSelf->testbench__DOT__a) 
                           & (IData)(vlSelf->testbench__DOT__cin))));
    bufp->fullBit(oldp+9,(((IData)(vlSelf->testbench__DOT__b) 
                           & (IData)(vlSelf->testbench__DOT__cin))));
    bufp->fullBit(oldp+10,(((IData)(vlSelf->testbench__DOT__a) 
                            & ((IData)(vlSelf->testbench__DOT__b) 
                               | (IData)(vlSelf->testbench__DOT__cin)))));
    bufp->fullBit(oldp+11,(vlSelf->testbench__DOT__clk));
    bufp->fullBit(oldp+12,(vlSelf->testbench__DOT__reset));
    bufp->fullBit(oldp+13,(vlSelf->testbench__DOT__s));
    bufp->fullBit(oldp+14,(vlSelf->testbench__DOT__cout));
    bufp->fullIData(oldp+15,(vlSelf->testbench__DOT__vectornum),32);
    bufp->fullIData(oldp+16,(vlSelf->testbench__DOT__errors),32);
    bufp->fullIData(oldp+17,(vlSelf->testbench__DOT__unnamedblk1__DOT__i),32);
}

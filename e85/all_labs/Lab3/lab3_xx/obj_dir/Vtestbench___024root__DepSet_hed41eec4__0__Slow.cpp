...
#endif
            VL_FATAL_MT("thunderbird_tb.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__left = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__right = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__la = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__lb = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__lc = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__ra = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__rb = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__rc = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__expected = VL_RAND_RESET_I(6);
    ...
    vlSelf->testbench__DOT__dut__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->testbench__DOT__dut__DOT__next_state = VL_RAND_RESET_I(3);

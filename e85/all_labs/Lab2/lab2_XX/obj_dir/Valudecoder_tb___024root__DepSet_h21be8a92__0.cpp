...
VL_INLINE_OPT void Valudecoder_tb___024root___act_comb__TOP__0(Valudecoder_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->aludecoder_tb__DOT__dut__DOT__T1 = (IData)(
                                                       (1U 
                                                        == (IData)(vlSelf->aludecoder_tb__DOT__ALUOp)));
    vlSelf->aludecoder_tb__DOT__dut__DOT__R = (IData)(
                                                      (2U 
                                                       == (IData)(vlSelf->aludecoder_tb__DOT__ALUOp)));
    vlSelf->aludecoder_tb__DOT__dut__DOT__Z = (1U & 
                                               (~ (IData)(
                                                          (0U 
                                                           != (IData)(vlSelf->aludecoder_tb__DOT__funct3)))));
    vlSelf->aludecoder_tb__DOT__dut__DOT__S = (IData)(
                                                      (2U 
                                                       == 
                                                       (3U 
                                                        & (IData)(vlSelf->aludecoder_tb__DOT__funct3))));
    vlSelf->aludecoder_tb__DOT__ALUControl = ((6U & (IData)(vlSelf->aludecoder_tb__DOT__ALUControl)) 
                                              | (((IData)(vlSelf->aludecoder_tb__DOT__dut__DOT__T1) 
                                                  | (((IData)(vlSelf->aludecoder_tb__DOT__dut__DOT__R) 
                                                      & (IData)(vlSelf->aludecoder_tb__DOT__dut__DOT__Z)) 
                                                     & ((IData)(vlSelf->aludecoder_tb__DOT__op5) 
                                                        & (IData)(vlSelf->aludecoder_tb__DOT__funct75)))) 
                                                 | ((IData)(vlSelf->aludecoder_tb__DOT__dut__DOT__R) 
                                                    & (IData)(vlSelf->aludecoder_tb__DOT__dut__DOT__S))));

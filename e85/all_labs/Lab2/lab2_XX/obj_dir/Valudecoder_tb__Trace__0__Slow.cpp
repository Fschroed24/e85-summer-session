...
VL_ATTR_COLD void Valudecoder_tb___024root__trace_init_sub__TOP__0(Valudecoder_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,0,"ALUControl",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBus(c+6,0,"ALUControl",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBit(c+7,0,"T1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+8,0,"R",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+9,0,"Z",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+10,0,"S",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
...
VL_ATTR_COLD void Valudecoder_tb___024root__trace_full_0_sub_0(Valudecoder_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,(vlSelf->aludecoder_tb__DOT__ALUControl),3);
    bufp->fullBit(oldp+7,(vlSelf->aludecoder_tb__DOT__dut__DOT__T1));
    bufp->fullBit(oldp+8,(vlSelf->aludecoder_tb__DOT__dut__DOT__R));
    bufp->fullBit(oldp+9,(vlSelf->aludecoder_tb__DOT__dut__DOT__Z));
    bufp->fullBit(oldp+10,(vlSelf->aludecoder_tb__DOT__dut__DOT__S));
    bufp->fullBit(oldp+11,(vlSelf->aludecoder_tb__DOT__clk));
    bufp->fullBit(oldp+12,(vlSelf->aludecoder_tb__DOT__reset));
    bufp->fullIData(oldp+13,(vlSelf->aludecoder_tb__DOT__vectornum),32);
    bufp->fullIData(oldp+14,(vlSelf->aludecoder_tb__DOT__errors),32);
    bufp->fullIData(oldp+15,(vlSelf->aludecoder_tb__DOT__unnamedblk1__DOT__i),32);
}

...
void Valudecoder_tb___024root__trace_chg_0_sub_0(Valudecoder_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[3U] 
        ...
        bufp->chgCData(oldp+5,(vlSelf->aludecoder_tb__DOT__ALUControl),3);
        bufp->chgBit(oldp+6,(vlSelf->aludecoder_tb__DOT__dut__DOT__T1));
        bufp->chgBit(oldp+7,(vlSelf->aludecoder_tb__DOT__dut__DOT__R));
        bufp->chgBit(oldp+8,(vlSelf->aludecoder_tb__DOT__dut__DOT__Z));
        bufp->chgBit(oldp+9,(vlSelf->aludecoder_tb__DOT__dut__DOT__S));
    }
    bufp->chgBit(oldp+10,(vlSelf->aludecoder_tb__DOT__clk));
    bufp->chgBit(oldp+11,(vlSelf->aludecoder_tb__DOT__reset));
    bufp->chgIData(oldp+12,(vlSelf->aludecoder_tb__DOT__vectornum),32);
    bufp->chgIData(oldp+13,(vlSelf->aludecoder_tb__DOT__errors),32);
    bufp->chgIData(oldp+14,(vlSelf->aludecoder_tb__DOT__unnamedblk1__DOT__i),32);
}

...
VL_ATTR_COLD void Valudecoder_tb___024root___ctor_var_reset(Valudecoder_tb___024root* vlSelf) {
    ...
    vlSelf->aludecoder_tb__DOT__dut__DOT__T1 = VL_RAND_RESET_I(1);
    vlSelf->aludecoder_tb__DOT__dut__DOT__R = VL_RAND_RESET_I(1);
    vlSelf->aludecoder_tb__DOT__dut__DOT__Z = VL_RAND_RESET_I(1);
    vlSelf->aludecoder_tb__DOT__dut__DOT__S = VL_RAND_RESET_I(1);

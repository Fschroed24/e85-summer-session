...
#endif
            VL_FATAL_MT("adventure_tb.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtestbench___024root___ctor_var_reset(Vtestbench___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__G0 = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__G1 = VL_RAND_RESET_I(1);
    ...
    for (int __Vi0 = 0; __Vi0 < 10001; ++__Vi0) {
        vlSelf->testbench__DOT__testvectors[__Vi0] = VL_RAND_RESET_I(6);
    }
    vlSelf->testbench__DOT__dut__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->testbench__DOT__dut__DOT__next_state = VL_RAND_RESET_I(3);
    vlSelf->testbench__DOT__dut__DOT__sword_state = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__dut__DOT__next_sword_state = VL_RAND_RESET_I(1);
